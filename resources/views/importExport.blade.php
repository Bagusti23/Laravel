...
<br/>
	<div class="container">		
		<div class="panel panel-primary">
		  <div class="panel-heading">
		    <h3 class="panel-title" style="padding:10px 0px;font-size:20px;"><strong>Import Data Pegawai</strong></h3>
		  </div>
	...
	<center><footer id="footer">
        <a href="https://www.polines.ac.id/id/" target="_blank">Politeknik Negeri Semarang</a> &copy; <?php echo date('Y');?> All Rights Reserved.
    </footer></center>
