...
<div class="panel panel-default">
    <div class="panel-body">
        <h4><i class="fa fa-user"></i> Data Dosen</h4><hr>
        ...
        <div class=row>
            <div class="col-md-6">
                ...
                <a href="{{route('password.change')}}" class="btn btn-danger"><i class="glyphicon glyphicon-warning-sign"></i> Ganti Password</a>
            </div>
            <div class="col-md-2">
            </div>
                       ...
                       <tr>
                           ...
                           <td align="center" width="30px">
                            <form method="POST" action="{{ route('crud.destroy', $crud->id) }}" accept-charset="UTF-8">
                              ...
                              <input type="submit" class="btn btn-danger" onclick="return confirm('Warning !!! Apakah anda ingin menghapus data ini ?');" value="Hapus">
                            </form>
                           </td>
                       </tr>
                   @endforeach
        ...
        @else
            <div class="alert alert-warning">
                <i class="fa fa-exclamation-triangle"></i> Nama Dosen Yang Dicari Tidak Tersedia
            </div>
        @endif
